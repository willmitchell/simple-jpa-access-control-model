 ...
 * @generated
 */
@javax.persistence.Entity@javax.persistence.Table(name = "USERTABLE")
public class User
{
	/**
	 * <!-- begin-user-doc -->
	...
	public void addGroups(Group newGroups) {
		...
		if (this.groups.add(newGroups))
			newGroups.basicSetUser(this);	
	}
	...
	public void removeGroups(Group oldGroups) {
		...
		if (this.groups.remove(oldGroups))
			oldGroups.unsetUser();
